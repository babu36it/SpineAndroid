...
class SpineForYouFragment : Fragment(), KodeinAware, SpineForYouEventListener,
    ...
    companion object {
        const val EVENT_POST_ID = "eventPostId"
        const val IS_EVE_FROM_POST = "isEveFromPost"
    }
    ...
    private val eventRepositry: EventRepository by instance()
...
//                }
    ...
    private fun setFollowers() {
        lifecycleScope.launch {
            try {
                val followersRes = eventRepositry.getFollowers(1, 100, userId)
