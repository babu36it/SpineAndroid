 ...
 */
class PostOptionsAdapter(val colors: ArrayList<ThoughtsData>, val context: Context, val listener: ThoughtEventListener): RecyclerView.Adapter<PostOptionsAdapter.OptionsHolder>() {
    ...
    class OptionsHolder(thoughtOptionsItemBinding: ThoughtOptionsItemBinding):RecyclerView.ViewHolder(thoughtOptionsItemBinding.root) {
