...
class StoryActivity : AppCompatActivity(),KodeinAware, StoryEventListener,
    StoryAdapter.StoryEventListener, StoriesAdapter.StoryEventListener {
    ...
    override fun onStoryFollowing(allUserData: AllUsersData) {
        lifecycleScope.launch {
            try {
    ...
    override fun onViewSomeonesProfile(allUserData: AllUsersData) {
