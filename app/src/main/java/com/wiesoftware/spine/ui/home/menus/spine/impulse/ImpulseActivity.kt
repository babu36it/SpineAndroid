        ...
        Coroutines.main {
            try {
                ...
                impulseList.add(
                    SpineImpulseData(
                        "",
                        getString(R.string.spine_dumy_description),
                        "",
                        "",
                        "Spine",
                        "1",
                ...
                var mAdapter = BaseAdapter<SpineImpulseData>(this@ImpulseActivity)
                mAdapter!!.listOfItems = impulseList
                mAdapter!!.expressionViewHolderBinding = { data, viewBinding, context ->
                    var holder = viewBinding as ImpulseContentItemBinding
                    holder.viewModel = data
                    holder.textView32.setOnClickListener {
                        //impulseEventListener.
                        onComment(data)
                    }
                    holder.textView31.setOnClickListener {
                        // impulseEventListener.
                        onLike(data)
                    }
                ...
                mAdapter!!.expressionOnCreateViewHolder = { viewGroup ->
                    ImpulseContentItemBinding.inflate(
