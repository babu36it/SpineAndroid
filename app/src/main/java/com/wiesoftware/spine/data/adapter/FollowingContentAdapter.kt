...
/**
 * Created by Vivek kumar on 9/4/2020.
 * E-mail:- vivekpcst.kumar@gmail.com
 */
class FollowingContentAdapter(val postList: List<PostData>,val forYouContentEventListener: FollowingContentEventListener) : RecyclerView.Adapter<FollowingContentAdapter.ContentHolder>(),
    ...
    interface FollowingContentEventListener{
        /*fun onLikePost(postData: PostData)
        fun onCommentPost(postData: PostData, comment: String)
        fun showComments(postData: PostData)
        fun onSharePost(postData: PostData)
        fun onSavePost(postData: PostData)
        fun onViewSomeonesProfile(postData: PostData)*/
        ...
        fun onAdLinkClicked(website: String)

    }

    class ContentHolder(
       val forYouContentItemBinding: ForYouContentItemBinding,
       val context: Context
        ...
        fun setTextViewDrawableColor(textView: TextView, colorRed: Int) {
            for (drawable in textView.compoundDrawablesRelative) {
                if (drawable != null) {
                    drawable.colorFilter =
                        PorterDuffColorFilter(
                            ContextCompat.getColor(context, colorRed),
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) =
        ContentHolder(DataBindingUtil.inflate(LayoutInflater.from(parent.context),
    ...
    override fun onBindViewHolder(holder: ContentHolder, position: Int) {
        ...
        Glide.with(holder.forYouContentItemBinding.imageView5).load(url).error(R.drawable.ic_photo).into(holder.forYouContentItemBinding.imageView5)
        ...
        if (event_post.equals("1")){
            ...
            val tt=title.split(",")
            holder.forYouContentItemBinding.textView275.text=tt.get(0)//Start on: 2021-03-31 - 11:43:37
 ...
 */
        ...
        if (!file.isNullOrEmpty()){
            if (file.endsWith("mov",true) || file.endsWith("mp4",true) ||
                file.endsWith("3gp",true) || file.endsWith("mkv",true) || file.endsWith("avi",true)) {
                holder.forYouContentItemBinding.exoplayerView.visibility = View.VISIBLE
                holder.forYouContentItemBinding.exoplayerView.setBackgroundColor(ContextCompat.getColor(holder.context,R.color.text_black))
                val url = POST_BASE_IMG_FILE + file
                Log.e("vid::", url)
        ...
        if (user_like_status.equals("1")){
            holder.setTextViewDrawableColor(holder.forYouContentItemBinding.textView31,R.color.color_red)
            likeStatusList.add(true)
            isLikedNow=true
        }else{
            holder.setTextViewDrawableColor(holder.forYouContentItemBinding.textView31,R.color.gray_tint)
            isLikedNow=false
        ...
        if (postList[position].type.equals("2")){
            ...
            Glide.with(holder.forYouContentItemBinding.imageView5).load(uri).error(R.drawable.ic_photo).into(holder.forYouContentItemBinding.imageView5)
        }else{
