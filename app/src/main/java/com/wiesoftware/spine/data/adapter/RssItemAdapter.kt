...
import kotlinx.android.synthetic.main.rss_episode_item.view.imageButton46
import kotlinx.android.synthetic.main.rss_episode_item.view.view45
import kotlinx.android.synthetic.main.watch_pod_item.view.*

/**
 * Created by Vivek kumar on 4/9/2021.
 * Email: vivekpcst.kumar@gmail.com.
 */
class RssItemAdapter(val items: List<RssItem>) :
    RecyclerView.Adapter<RssItemAdapter.RssItemHolder>() {
    class RssItemHolder(val rssEpisodeItemBinding: RssEpisodeItemBinding) :
        RecyclerView.ViewHolder(rssEpisodeItemBinding.root) {
    ...
    override fun onBindViewHolder(holder: RssItemHolder, position: Int) {
        ...
        if (position == itemCount - 1) {
            holder.itemView.view45.visibility = View.GONE
        } else {
            holder.itemView.view45.visibility = View.VISIBLE
